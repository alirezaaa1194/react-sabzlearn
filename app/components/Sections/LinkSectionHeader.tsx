...
function LinkSectionHeader({ headerTitle, headerDesc, linkElem }: LinkSectionHeaderPropsType) {
  return (
    <div className="flex flex-col gap-y-2.5 mb-9 lg:mb-[52px] relative z-[2]">
      ...
      <div className={`flex flex-col lg:flex-row items-center justify-between ${linkElem ? "gap-y-6" : ""}`}>
