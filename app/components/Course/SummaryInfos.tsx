...
function SummaryInfos({course}:{course:singleCourseType}) {
  return (
          <div className="grid grid-cols-2 sm:grid-cols-3 gap-6">
            <SummaryInfosBox title="وضعیت دوره" desc={course.status === "start" ? "درحال ضبط" : "تکمیل شده"} icon={<InformationCircleIcon className="w-10 h-10 sm:w-11 sm:h-11 text-green-500" />} />
