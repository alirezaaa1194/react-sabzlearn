      ...
      <div className="p-[18px] md:p-5 bg-gray-200 dark:bg-darker rounded-lg">
        <div className="flex items-center justify-between pb-4 mb-4 border-b border-b-white/40 dark:border-white/10">
          <div className="flex items-center gap-x-3.5">
            <div className="border-sky-500 sm:flex-center w-15 h-15 border rounded-full relative p-1 hidden sm:block">
              ...
              <img src={gravatarProfileAdress(answerContent?.creator?.email)} className="w-12 h-12 block object-cover rounded-full" />
            </div>
