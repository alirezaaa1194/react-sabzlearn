  ...
  return (
    <div className="bg-white dark:bg-darker rounded-xl p-[18px] sm:p-5 mt-8" ref={descRef}>
      ...
      <div className="relative overflow-hidden">
        ...
        {containerHeight > 1200 ? <>{!isOpenDesc ? <div className="absolute bottom-0 right-0 left-0 h-[160px] bg-gradient-to-t from-white dark:from-darker from-0% via-white/[55%] dark:via-darker/[55%] via-70% to-white/0 dark:to-darker/0 to-100%"></div> : ""}</> : ""}
      </div>
      {containerHeight > 1200 ? (
        <Button onClick={seeMoreHandler} type="button" className="btn-primary--outline bg-transparent text-primary mx-auto mt-5 rounded-lg flex items-center font-DanaMedium">
