      ...
      <CustomModal
        ...
        desc={
          <div className="flex flex-col gap-2">
            {comment?.body} <textarea value={answerInputValue} onChange={(e) => setAnswerInputValue(e.target.value)} placeholder="پاسخ کامنت را وارد کنید..." className="w-full bg-darker border-none outline-none rounded-md p-2" rows={10}></textarea>{" "}
          </div>
        }
      />
