...
import { AcademicCapIcon, BarsIcon, BellIcon, ChatBubbleBottomCenterTextIcon, ChatBubbleLeftRightIcon, CloseIcon, HomeIcon, LogoIcon, ShoppingBagIcon, VideoCameraIcon } from "public/svg/svgs";
