  ...
  return (
    <aside className={`w-67 md:!w-1/5 fixed md:!sticky z-50 !top-0 !h-screen overflow-y-auto flex flex-col bg-darker font-lalezar transition-all -right-full md:!right-0 md:opacity-100 md:visible ${isOpenSidebar ? "right-0 opacity-100 visible" : "-right-full opacity-0 invisible"}`}>
      ...
      <ul>
        ...
        <li>
          <NavLink to="/admin-panel/menus" className="sidebar__link text-white flex items-center gap-2 p-[15px] hover:bg-gradient-to-r hover:from-white/10 hover:to-transparent active:border-l-4 active:border-l-secondary active:bg-gradient-to-r active:from-white/10 active:to-transparent">
            <BarsIcon className="size-7" />
            <span className="text-xl">منو ها</span>
          </NavLink>
        </li>
        <li>
          <NavLink to="/admin-panel/blog" className="sidebar__link text-white flex items-center gap-2 p-[15px] hover:bg-gradient-to-r hover:from-white/10 hover:to-transparent active:border-l-4 active:border-l-secondary active:bg-gradient-to-r active:from-white/10 active:to-transparent">
