...
function ThemeBtns() {
  ...
  return (
    <fetcher.Form method="POST" action="/switchTheme">
      <button type="submit" className="w-13 h-13 rounded-full hidden lg:flex items-center justify-center bg-gray-100 text-slate-500 dark:bg-white/5 dark:text-white">
