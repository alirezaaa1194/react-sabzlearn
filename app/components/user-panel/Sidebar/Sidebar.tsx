...
function Sidebar({ isOpenSidebar, setIsOpenSidebar }: { isOpenSidebar: boolean; setIsOpenSidebar: (param: boolean) => void }) {
  return (
    <aside className={`w-67 h-svh fixed md:sticky top-0 !z-[100000000] transition-all ${isOpenSidebar ? "right-0 opacity-100 visible" : "-right-full opacity-0 invisible"} md:right-0 md:opacity-100 md:visible overflow-y-auto bg-white dark:bg-darker px-6 py-[18px] flex flex-col items-center justify-between`}>
